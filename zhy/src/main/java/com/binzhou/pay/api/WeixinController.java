package com.binzhou.pay.api;

import com.alibaba.fastjson.JSONObject;
import com.binzhou.pay.utils.StringUtils;
import com.binzhou.pay.utils.weixin.PayUtil;
import com.binzhou.pay.utils.weixin.config.WxPayConfig;
import com.binzhou.pay.utils.weixin.vo.OAuthJsToken;
import com.binzhou.pay.vo.Json;
...
import com.binzhou.pay.utils.UUIDGenerator;
...
public class WeixinController extends WeixinSupport {
    ...
    private static final String appid = "wx64db6c2b70842ec1";        //微信小程序appid
    private static final String secret = "6b97c04aae688c9e2a92a05cf290518c";    //微信小程序密钥
    ...
    public Json wxPay(String openid, HttpServletRequest request) {
        ...
        try {
            ...
            String body = "测试商品名称";
            //获取本机的ip地址
            String spbill_create_ip = "140.143.130.113";//IpUtils.getIpAddr(request);
